...
<div class="card-body">
  <form action="{{ route('simpandokter') }}" method="post">
    ...
    <div class="form-group">
      <input type="text" id="id" name="id" class="form-control" placeholder="ID Dokter" required oninvalid="this.setCustomValidity('ID Pengguna Tidak Boleh Kosong')" oninput="this.setCustomValidity('')">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <textarea name="username" id="username" class="form-control" placeholder="Username" required oninvalid="this.setCustomValidity('Alamat Tidak Boleh Kosong')" oninput="this.setCustomValidity('')"></textarea>
      </div>
