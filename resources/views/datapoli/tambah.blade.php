...
<div class="card-body">
  <form action="{{ route('simpanpoli') }}" method="post">
    ...
    <div class="form-group">
      <input type="text" id="id" name="id" class="form-control" placeholder="ID Poliklinik" required oninvalid="this.setCustomValidity('ID Poliklinik Tidak Boleh Kosong')" oninput="this.setCustomValidity('')">
      </div>
